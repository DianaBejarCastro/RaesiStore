...
<head>
    ...
    <title>CategoriaPoleras | Raesi</title>
...
<?php require_once "config/conexion.php";?>
  ...
  <section class="hero hero-poleras d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      <h1>Categoria Poleras</h1>
      <h2>Con la ropa te mueves por la vida. Elige prendas de calidad, que te puedan llevar el ritmo.</h2>
    </div>
  </section>
...
<div class="col-sm-9 ">
  <div class="features_items">
      ...
      <div class="container px-4 px-lg-5">
          ...
          <?php
        $query = mysqli_query($conexion, "SELECT p.*, c.id AS id_cat, c.categoria FROM productos p INNER JOIN categorias c ON c.id = p.id_categoria WHERE categoria='poleras'");
