...
include("vistaWeb/cabezera.php")?>
  ...
  <section class="hero hero-mujer d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      <h1>Categoria Mujer</h1>
      <h2>Somos una casa de moda, belleza y encanto. Vestimos con pasión.</h2>
    </div>
  </section>
        ...
        <section class="py-5">
          <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-2 row-cols-xl-3 justify-content-center">
              ...
              <?php
        $query = mysqli_query($conexion, "SELECT * FROM productos WHERE genero='femenino'");
                      ...
                      <div class="portfolio-info">
                        ...
                        <div class="portfolio-links">
                          <a type="button" class="detallesbtn"
                            href="detalles.php?accion=pro&id=<?php echo $data['id']; ?>"" title=" More Details"> ver
                            detalles</a>
                        </div>
                      </div>
