...
<?php require_once "config/conexion.php";?>
  ...
  <section class=" hero hero-unisex d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      <h1>Categoria Uniex</h1>
      <h2>No podrás comprar la felicidad, pero si el outfit para esa ocasión especial. No notaras la diferencia.</h2>
    </div>
  </section>
...
<div class="col-sm-9 ">
  <div class="features_items">
      ...
      <div class="container px-4 px-lg-5">
          ...
          <?php
        $query = mysqli_query($conexion, "SELECT * FROM productos WHERE genero='unisex'");
