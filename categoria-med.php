...
<head>
    ...
    <title>CategoriMedico | Raesi</title>
...
<?php require_once "config/conexion.php";?>
  ...
  <section class=" hero hero-medicina d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      <h1>Categoria Uniformes medicos</h1>
      <h2>Que tu ropa sea tan resistente, como el espíritu y la energía con la que construyes tu vida.</h2>
    </div>
  </section>
...
<div class="col-sm-9 ">
  <div class="features_items">
      ...
      <div class="container px-4 px-lg-5">
          ...
          <?php
        $query = mysqli_query($conexion, "SELECT p.*, e.id AS id_esp, e.especialidad  FROM productos p INNER JOIN especialidades e ON e.id = p.id_especialidad");
