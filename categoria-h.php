...
<head>
    ...
    <title>CategoriaHombre | Raesi</title>
...
<?php require_once "config/conexion.php";?>
  ...
  <section class=" hero hero-hombre d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      <h1>Categoria Varón</h1>
      <h2>Te sientes bien, te luce bien. No es cuestión de seguir la moda, es cuestión de tener actitud.</h2>
    </div>
  </section>
...
<div class="col-sm-9 ">
  <div class="features_items">
      ...
      <div class="container px-4 px-lg-5">
          ...
          <?php
        $query = mysqli_query($conexion, "SELECT * FROM productos WHERE genero='masculino'");
